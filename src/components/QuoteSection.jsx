  ...
  return (
    <section className="w-full py-12 sm:py-16 lg:py-20 bg-[#FBF0E4] relative overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center z-10">
        ...
        >
          "In a world filled with machines, we still believe in the beauty of handmade paper —<br className="hidden md:block" /> crafted slowly, touched by human hands,<br className="hidden md:block" /> and made to preserve stories that last forever."
        </h3>
