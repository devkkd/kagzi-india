...
const Stages = () => {
  ...
  const stagesData = [
    { id: 'stage-1', navTitle: 'Stage 01', sub: '01 Stage One', title: 'Sorting', desc: "Every piece of collected cotton fabric is carefully sorted by hand, where usable fibres are separated from unwanted material. Only clean and high-quality cotton is chosen to begin its journey into handmade paper.", meta: "100% Cotton | Hand Sorted", img: '/images/papermaking/Stages1.JPG' },
    { id: 'stage-2', navTitle: 'Stage 02', sub: '02 Stage Two', title: 'Cutting', desc: "The sorted cotton rags are carefully cut into smaller, even-sized pieces to prepare the fibres for the next stage of paper making. Keeping the pieces uniform helps create a smoother and more consistent pulp, which later becomes the foundation for high-quality hand made paper, recycled paper, decorative paper,and other handmade products crafted with precision and care.", meta: "Uniform Fibre", img: '/images/papermaking/Stages2.JPG' },
    { id: 'stage-3', navTitle: 'Stage 03', sub: '03 Stage Three', title: 'Pulping', desc: "The cut cotton rags are soaked in water and gently beaten into soft pulp using traditional wooden mallets — no bleach or harsh chemicals, only natural fibres, water, and time.", meta: "Zero Chemicals | Clean Water", img: '/images/papermaking/Stages3.JPG' },
    { id: 'stage-4', navTitle: 'Stage 04', sub: '04 Stage Four', title: 'Sheet Making', desc: "The pulp is suspended in open vats, where skilled artisans lift a mould and deckle through the mixture to form an even fibre layer. This simple handcrafted process gives shape to every sheet of hand made paper with precision and care.", meta: "Deckle Edge | By Hand", img: '/images/papermaking/Stages4.png' },
    ...
    { id: 'stage-10', navTitle: 'Stage 10', sub: '10 Stage Ten', title: 'Paper Shipping', desc: "Finished paper sheets are carefully moved to the workshop, where they are transformed into premium paper products such as journal notebook collections, bags, boxes, paper notebook designs, and other handcrafted creations.", meta: "Internal Transfer", img: '/images/papermaking/Stages10.JPG' },
    { id: 'stage-11', navTitle: 'Stage 11', sub: '11 Stage Eleven', title: 'Cutting', desc: "The handmade paper sheets are cut with precision into product dimensions, envelope sizes, book pages, and bag panels — ensuring consistency and quality in every paper product and handmade diary creation.", meta: "Precision Cut | Custom Size", img: '/images/papermaking/Stages11.JPG' },
